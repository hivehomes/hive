...
export default function Banner() {
  ...
  return (
    <div className={`container ${isBannerShown ? 'h-16' : 'h-0'}`}>
      <div
        id="marketing-banner"
        className={`${
      ...
      >
        <div className="flex flex-col items-start mb-3 me-4 md:items-center md:flex-row md:mb-0">
          ...
          <div className="flex items-center text-sm font-normal text-gray-600 dark:text-gray-400 gap-2">
            <p className="font-semibold">Elevator 2 Maintenance:</p> Monday,
            March 18th: Please be advised that Elevator 2 will undergo routine
