...
export default async function Header() {
  ...
  return (
    <nav className="bg-slate-100 rounded-2xl m-5 border-gray-200 dark:bg-gray-900 flex justify-between items-center text-yellow-400">
      <div className="flex flex-wrap p-4 justify-between items-center">
        <a
          href="/"
          className="flex mr-5 items-center space-x-3 rtl:space-x-reverse"
        >
          <svg
            className="h-14"
      ...
      <div
        className="mr-5 flex items-center justify-between w-full md:flex md:w-auto md:order-1"
        id="navbar-user"
      >
        <div className="flex items-center justify-between">
          <p className="text-black mr-5">
            Welcome home,{' '}
            <span className="font-extrabold">{users?.first_name}</span>.
          </p>
