...
export default async function Header() {
  ...
  return (
    ...
    <nav className='bg-white border-gray-200 dark:bg-gray-900 flex justify-between text-yellow-400'>
      ...
      <div className='items-center justify-between hidden w-full md:flex md:w-auto md:order-1' id='navbar-user'>
        <ul className=' flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700'>
          <li>
            <a href='#' className='block py-2 px-3 text-yellow-400  bg-yellow-400 rounded md:bg-transparent md:text-yellow-400 md:p-0 md:dark:text-blue-500' aria-current='page'>Home</a>
          </li>
          <li>
            <a href='/dashboard' className='block py-2 px-3 text-yellow-400  bg-yellow-400 rounded md:bg-transparent md:text-yellow-400 md:p-0 md:dark:text-blue-500' aria-current='page'>Dashboard</a>
          </li>
          <li>
            <a href='/deliveries' className='block py-2 px-3 text-yellow-400  bg-yellow-400 rounded md:bg-transparent md:text-yellow-400 md:p-0 md:dark:text-blue-500' aria-current='page'>Deliveries</a>
          </li>
        </ul>
      </div>
    </nav>
